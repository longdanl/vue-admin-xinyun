	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.username" placeholder="用户ID"></el-input>
				</el-form-item>
				<el-form-item>
					<el-button type="primary" @click="getUsersById">查询</el-button>
				</el-form-item>
				<el-form-item>
					<el-button type="primary" @click="updateUsers">新增用户</el-button>
				</el-form-item>
		...
		<!--列表-->
		<el-table align:="center" :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 60%;">
			<el-table-column type="selection" width="55">
			</el-table-column>
			<el-table-column prop="username" label="用户名" width="200" sortable>
			</el-table-column>
			<el-table-column prop="phone" label="手机号码"  width="200" sortable>
			</el-table-column>
			...
			<el-table-column label="操作" width="153" class="showBtn">
...
export default {
	...
	methods: {
		...
		//编辑用户
		async updateUsers() {
			await updateUsers(this.editForm);
			this.editFormVisible = false;
